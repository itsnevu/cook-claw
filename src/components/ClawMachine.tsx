...
export function ClawMachine({ isGrabbing }: ClawMachineProps) {
    return (
        <div className="relative h-64 w-full overflow-hidden rounded-2xl border border-orange-300/25 bg-[radial-gradient(circle_at_20%_20%,rgba(251,146,60,0.22),transparent_45%),radial-gradient(circle_at_80%_15%,rgba(234,88,12,0.2),transparent_42%),linear-gradient(160deg,#0b0907,#1a120b_55%,#22170d)] sm:h-80 sm:w-80">
            ...
            <motion.div
                className="absolute bottom-9 left-1/2 h-8 w-44 -translate-x-1/2 rounded-[100%] bg-orange-900/45 blur-xl"
                animate={
                    isGrabbing
            ...
            <div className="absolute bottom-2 left-2 right-2 grid grid-cols-2 gap-2 text-[10px] uppercase tracking-[0.13em]">
                <motion.div
                    className="rounded-md border border-orange-300/30 bg-orange-950/45 px-2 py-1 text-orange-100/90"
                ...
                <motion.div
                    className="rounded-md border border-orange-300/30 bg-orange-950/35 px-2 py-1 text-orange-100/90"
                    animate={isGrabbing ? { opacity: [0.55, 1, 0.55] } : { opacity: [0.45, 0.78, 0.45] }}
